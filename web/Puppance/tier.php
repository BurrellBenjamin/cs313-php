        ...
        <main>
            <?php
                try{
                    ...
                    echo "<h1>" . htmlspecialchars($_GET["id"]) . "</h1><hr><br><br><br>Pokemon in this tier<hr><table id = 'pokemondetail'><tr><th>Pokemon</th><th>Type</th><th>Abilities</th><th>Tier</th></tr>";
